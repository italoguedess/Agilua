...
function Element.new(props)
  ...
  if props.gap then
    ...
    if type(props.gap) == "string" or isCalc then
      ...
      local containerSize = (flexDir == Element._utils.enums.FlexDirection.HORIZONTAL) and self.width
          or self.height
  ...
  if props.parent == nil then
    ...
    if props.bottom then
      ...
      if type(props.bottom) == "string" or isCalc then
        ...
        local resolvedBottom =
            Element._Units.resolve(value, unit, viewportWidth, viewportHeight, viewportHeight)
    ...
    elseif props.positioning == Element._utils.enums.Positioning.GRID then
      ...
      then
        self.positioning = Element._utils.enums.Positioning
        .ABSOLUTE                                                -- They are positioned BY flex/grid, not AS flex/grid
...
function Element:addChild(child)
  ...
  if child._originalPositioning == nil then
    ...
    then
      child.positioning = Element._utils.enums.Positioning
      .ABSOLUTE                                                  -- They are positioned BY flex/grid, not AS flex/grid
